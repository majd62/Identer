...
{
    public partial class acceptedCarLicenseListItem : UserControl
    {
        public acceptedCarLicenseListItem()
        {
            InitializeComponent();
        }
        ...
        {
            Xml.deleteOldLicense(_IdNumber, "CarLicense", _Chassisnumbe);
        ...
        {
            Edit edt = new Edit(_IdNumber, "CarLicense",_Index);
            edt.Show();
        }
    }
}
